...
// console.log(
//   quickSort([
//     3, 6, 8, 10, 1, 2, 1, 6, 5, 7, 9, 3, 5, 3, 1, 7, 9, 34, 28, 34, 29,
//   ])
// );
...
// console.log(myGraph.bfs("A")); // Output: ['A', 'B', 'C', 'D', 'E', 'F']
...
// console.log(dgraph.adjacencyList); //Output: ['A', 'B', 'D', 'E', 'C', 'F']
...
// console.log(huffmanEncoding("abcdef"));
...
// console.log("dijkstra", dijkstra(graph, "A"));
